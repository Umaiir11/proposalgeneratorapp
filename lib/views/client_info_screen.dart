                        ...
                        child: Column(
                          ...
                          children: [
                            ...
                            _buildTextField(
                              ...
                              onChanged: (v) =>
                                  controller.updateClientInfo(clientName: v),
                            ...
                            _buildTextField(
                              ...
                              onChanged: (v) =>
                                  controller.updateClientInfo(businessName: v),
                              validator: (v) => v?.isEmpty ?? true
                            ...
                            _buildTextField(
                              ...
                              onChanged: (v) =>
                                  controller.updateClientInfo(email: v),
                              validator: (v) {
                                if (v?.isEmpty ?? true)
                            ...
                            _buildTextField(
                              ...
                              onChanged: (v) =>
                                  controller.updateClientInfo(phone: v),
                              validator: (v) => v?.isEmpty ?? true
                            ...
                            _buildDropdown(
                              ...
                              items: [1, 2, 3, 4, 5],
                              onChanged: (v) => controller.updateClientInfo(
                                numberOfPackages: v ?? 1,
                              ),
                            ),
                            const SizedBox(height: 24),
                          ],
